/*
danzup arduino atmega2560 6 LM50 sensor , 1 relay 
*/
#include <SPI.h>
#include <Ethernet.h>
...
void loop()
{
 ...
 dtostrf(temperature1B, 4, 2, sensor2Temp);
 ...
 dtostrf(temperature1C, 4, 2, sensor3Temp);
 ...
 dtostrf(temperature1D, 4, 2, sensor4Temp);
...
//--------lm 50  senzor 5------------------
 ...
 dtostrf(temperature1E, 4, 2, sensor5Temp);
...
//--------lm 50  senzor 6------------------
 ...
 dtostrf(temperature1F, 4, 2, sensor6Temp);
  ...
  //  hic = hic - 1;
    ...
    client.publish("camera_tehnica/temperature5", sensor5Temp);
    client.publish("camera_tehnica/temperature6", sensor6Temp); 
